...
export default function ReportDetailPage() {
  ...
  const handleProofAttached = (summary: {
    serverName: string;
    sessionTime: string;
    sentLen: number;
    recvLen: number;
    ...
    setReport((r) =>
      r
        ? {
            ...
            tlsProofServerName: summary.serverName,
            tlsProofTime: summary.sessionTime,
          }
        : r
    );
                ...
                <p className="text-sm text-gray-500">
                  ...
                  {isReporter ? (
                    <span>
                      ...
                      generated by the TLSNotary prover to cryptographically
                      verify your PoC.
                    </span>
                  ) : (
